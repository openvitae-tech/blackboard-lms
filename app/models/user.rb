...
class User < ApplicationRecord
  ...
  validates :phone, numericality: true, length: { minimum: 10, maximum: 10 }, allow_nil: true, uniqueness: { message: "Please set a valid phone number. Phone number has to be unique." }
